...
char read_path[] = "/home/arch_stu2021010726/yao-archlab-f22/lab1/sample/turing_before.pixel";
char write_path[] = "/home/arch_stu2021010726/yao-archlab-f22/lab1/run/turing-c.pixel";
//------------------------------------------------------------------------------------------------------------------
...
void image_process() {
    ...
    // CYLCES: 70909765  CPI: 1.15  IPC: 0.873
    int K[9] = {0,1,0,1,2,1,0,1,0}; //store logK[i][j]
    for(int x=0; x<n; x++){
        for(int y=0; y<m; y++){
